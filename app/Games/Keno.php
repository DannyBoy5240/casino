...
class Keno extends QuickGame implements MultiplierCanBeLimited {
  ...
  public function data(): array {
    return [
      1 => $this->applyHouseEdge([0.405, 2.784]),
      2 => $this->applyHouseEdge([0, 1.825, 5.172]),
      3 => $this->applyHouseEdge([0, 0, 2.835, 50.63]),
      4 => $this->applyHouseEdge([0, 0, 1.74, 10.23, 102.35]),
      5 => $this->applyHouseEdge([0, 0, 1.41, 4.05, 14.18, 395.12]),
      6 => $this->applyHouseEdge([0, 0, 0, 3.04, 9.13, 182.71, 720.70]),
      7 => $this->applyHouseEdge([0, 0, 0, 2.02, 7.08, 30.34, 404.64, 809.29]),
      8 => $this->applyHouseEdge([0, 0, 0, 2.02, 4.04, 11.13, 67.81, 404.85, 910.92]),
      9 => $this->applyHouseEdge([0, 0, 0, 2.02, 2.52, 5.05, 15.17, 101.19, 505.98, 1011.96]),
      10 => $this->applyHouseEdge([0, 0, 0, 1.61, 2.02, 4.04, 7.07, 26.28, 101.08, 505.42, 1010.84])
    ];
  }
