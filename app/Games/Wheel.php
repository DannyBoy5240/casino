...
class Wheel extends QuickGame implements MultiplierCanBeLimited {
  ...
  public function start($user, Data $data) {
    if ($data->game()->mode === 'double') {
      return new SuccessfulQuickGameResult((new ProvablyFair($this))->result(), function (SuccessfulQuickGameResult $result) use ($user, $data) {
        ...
        else $result->win($user, $data, $target == $red || $target == $black ? HouseEdgeModule::apply($this, 2.14) : HouseEdgeModule::apply($this, 14.92));
  ...
  public function data(): array {
    if (!Cache::has('phoenix:wheelMultipliers:' . HouseEdgeModule::get($this, 1.00))) {
      $output =  [
        'wheel-double-red' => HouseEdgeModule::apply($this, 2.14),
        'wheel-double-black' => HouseEdgeModule::apply($this, 2.14),
        'wheel-double-green' => HouseEdgeModule::apply($this, 14.92),
        'wheel-x50-green' => HouseEdgeModule::apply($this, 5),
        'wheel-x50-yellow' => HouseEdgeModule::apply($this, 50),
        'wheel-x50-black' => HouseEdgeModule::apply($this, 2),
        'wheel-x50-red' => HouseEdgeModule::apply($this, 3),
      ];
      Cache::forever('phoenix:wheelMultipliers:' . HouseEdgeModule::get($this, 1.00), json_encode($output));
    }
    return json_decode(Cache::get('phoenix:wheelMultipliers:' . HouseEdgeModule::get($this, 1.00)), true);
  }
