...
abstract class MultiplayerGame extends ExtendedGame {
  ...
  public function client_seed($id = null) { // it must be compatible with Game.php class
    return $this->state()->clientSeed();
  }

  public function server_seed($id = null) { // it must be compatible with Game.php class
    return $this->state()->serverSeed();
  }

  public function nonce($id = null) { // it must be compatible with Game.php class
