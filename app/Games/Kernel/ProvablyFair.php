...
class ProvablyFair {
    ...
    public function __construct(Game $game, string $server_seed = null, $game_id = null) {
        $this->game = $game;
        $game_id ? $this->client_seed = $game->client_seed($game_id) : $this->client_seed = $game->client_seed();
        $this->server_seed = $server_seed == null ? $game->server_seed() : $server_seed;
        $game_id ? $this->nonce = $game->nonce($game_id): $this->nonce = $game->nonce();
    }
