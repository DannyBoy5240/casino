...
class Limbo extends QuickGame implements MultiplierCanBeLimited {
  ...
  function result(ProvablyFairResult $result): array {
    $max_multiplier = 1e8;
    $house_edge = HouseEdgeModule::get($this, 1.00);
    $float_point = $max_multiplier / ($result->extractFloat() * $max_multiplier) * ((100 - $house_edge) / 100);
  ...
  public function data(): array {
    return [
      'limbo-house-edge' => HouseEdgeModule::get($this, 1.00)
    ];
  }
