    ...
    export default {
        ...
        methods: {
                    ...
                    case 'MultiplayerBetCancellation':
                       console.log(data);
                        this.cashoutTexts.push({
                            name: data.user.name,
                            alpha: 1,
                            multiplier: parseFloat(data.game.multiplier).toFixed(2),
                            x: this.linePosX,
                            y: this.linePosY
                        });
                        break;
                ...
                const nextMultiplier = () => {
                    ...
                    */
                    ...
                    if(this.placedBetThisRound) {
                        ...
                        // autoCashout is handled on server instead of simulating a click
                    }
                }
            ...
            callback(response) {
                ...
                console.log('value of placedBetThisRounds is: ');
                console.log(this.placedBetThisRound);
