    ...
    methods: {
      ...
      recalculateMultipliers() {
        let calculateMultiplier = (type) => {
          ...
          if(type === 'higher') return parseFloat(12.350 / (13 - deck[this.startingCardIndex].slot));
          if(type === 'lower') return parseFloat(12.350 / (deck[this.startingCardIndex].slot - 1));
          if(type === 'same') return parseFloat(16.83);
        };
