...
<script>
    ...
    export default {
       ...
       async  mounted() {
            //console.log('parent name: ' + this.$parent.game.id);
            if(this.$parent.game.id == 'wheel')  this.components = await this.$parent.$refs.gameComponent.getSidebarComponents();
            else this.components = this.$parent.$refs.gameComponent.getSidebarComponents();
        },
        computed: {
