        ...
        methods: {
            ...
            init() {
                ...
                $('[data-chip]').on('click', function() {
                    ...
                    if(instance.chipDisplayValue != 1000000000000 && $(this).find(`div [data-token-value="${instance.chip}"]`)?.length == 9) {
                        $(this).find(`div [data-token-value="${instance.chip}"]`).remove();
                        const e = $(`<div class="user-chip" data-display-value="${instance.chipDisplayValue * 10}" data-token-value="${instance.chip * 10}" style="margin-top: -${stack.children().length * 2}px">${instance.abbreviate(instance.chipDisplayValue*10)}</div>`);
                        stack.append(e);
                    }
                    else {
